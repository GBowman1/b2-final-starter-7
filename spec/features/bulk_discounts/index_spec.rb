    ...
    describe "as a merchant" do
        ...
        scenario "when I visit the bulk discounts index page" do
            it "I can see all of my bulk discounts including their percentage discount and quantity thresholds" do
                ...
                bulk_discount_3 = merchant.bulk_discounts.create!(percentage_discount: 30, quantity_threshold: 30)
